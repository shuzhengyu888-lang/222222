...
const UUID = process.env.UUID || 'b147814e-0475-499d-9367-bb969f5a8f28'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'xjpnb.xijingping.de5.net';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjk0NzBhYTlkZWZlOTMzMGFhMDRmMWI3Zjc2M2ZhZDEiLCJ0IjoiY2YyODZjZDgtNjI4Ny00ZGFmLWE4MDItM2NmYmE4ZTIwMWZmIiwicyI6Ik9EYzVOalZpTURjdFpqVTNOQzAwWWpJeUxXRTBORFV0TXpsbE9XRmxZelJrTWpNeiJ9
...
const NAME = process.env.NAME || '坚持中特社';                        // 节点名称
